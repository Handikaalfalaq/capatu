...
public class RefCodeController {
    ...
    public ResponseEntity<?> getPageableByFilters(@Valid @RequestBody RefCodeSearchRequest request) {
        return ResponseEntity.ok(refCodeService.getPageableByFilters(request));
    }
